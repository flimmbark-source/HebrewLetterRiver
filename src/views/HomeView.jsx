      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-lg font-bold line-clamp-1">{options.find((option) => option.id === value)?.name ?? value}</p>
          </div>
        </div>
        {trailing}
      </div>
        ...
        <section>
          <div className="stable-card flex flex-col items-center space-y-4 rounded-2xl border border-[#1b6b4f]/5 bg-white p-8 text-center shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-[#4a6365] line-clamp-1">Learning since January 2024</p>
            </div>
          ...
          <div className="stable-card space-y-4 rounded-2xl bg-[#f9f1fd] p-5">
            <div className="space-y-3">
              ...
              {recentLetters.length > 0 ? (
                ...
                <p className="text-sm text-[#4a6365] line-clamp-2-stable">Catch a few letters to unlock your mastery row.</p>
              )}
            ...
            <div className="space-y-2">
              ...
              {recentModes.length > 0 ? (
                ...
                <p className="text-sm text-[#4a6365] line-clamp-2-stable">Start a game and your latest activity will appear here.</p>
              )}
            </div>
          ...
          <div className="stable-card space-y-3 rounded-2xl bg-[#f9f1fd] p-6">
            ...
            <div>
              ...
              {isEditingGoal ? (
                ...
                <p className="text-sm text-[#4a6365] line-clamp-1">{dailyGoalMinutes} mins / day</p>
              )}
            </div>
          </div>
          <div className="stable-card space-y-3 rounded-2xl bg-[#f9f1fd] p-6">
            ...
            <div>
              ...
              {isEditingReminder ? (
                ...
                <p className="text-sm text-[#4a6365] line-clamp-1">
