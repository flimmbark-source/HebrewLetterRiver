  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center justify-between">
        <h4 className="font-bold text-[#1d1a22] line-clamp-1">{name}</h4>
      ...
      <p className="text-xs text-[#4a6365] line-clamp-2-stable">{summary}</p>
...
export default function AchievementsView() {
  ...
  return (
    <div className="min-h-screen bg-[#fef7ff] px-6 pb-36 pt-8">
        ...
        <section className="mb-10 grid grid-cols-2 gap-4">
          <div className="stable-card col-span-2 flex items-center justify-between overflow-hidden rounded-lg bg-[#f9f1fd] p-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-[#3f4943] line-clamp-2-stable">
          ...
          {milestones.map((badge, index) => {
            ...
            return (
              <div key={badge.id} className={`stable-card flex flex-col rounded-lg p-5 ${index === 0 ? 'bg-[#e7e0eb]' : 'bg-[#f9f1fd]'}`}>
                ...
                <div>
                  <h4 className="mb-1 text-lg font-bold leading-tight line-clamp-1">{getBadgeCopy(badge, t, gameName, goal).name}</h4>
                  <p className="text-xs text-[#3f4943] line-clamp-2-stable">{getBadgeCopy(badge, t, gameName, goal).summary}</p>
                    ...
                    <div key={badge.id} className="stable-card flex items-center gap-5 rounded-xl p-4 transition-all hover:bg-[#f9f1fd]">
                      ...
                      <div className="flex-1">
                        <div className="mb-1 flex items-end justify-between">
                          <h4 className="font-bold line-clamp-1">{getBadgeCopy(badge, t, gameName, goal).name}</h4>
                          <span className="text-[10px] font-bold text-[#3f4943]">{current}/{goal}</span>
                        </div>
                        <p className="mb-2 text-xs text-[#3f4943] line-clamp-2-stable">{getBadgeCopy(badge, t, gameName, goal).summary}</p>
