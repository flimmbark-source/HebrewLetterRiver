...
export const gearDefinitions = [
  ...
  // --- Interpreter gear ---
  {
    ...
    icon: '🏮',
    shortDesc: 'Pick 1/2',
    detailedDescription: 'See 2 tiles, pick 1. At least 1 is from the target word.',
    type: 'scry',
    energyCost: 1,
    cooldown: 0,
    uses: -1,
  ...
  // --- Rootkeeper gear ---
  {
    ...
    icon: '🔍',
    shortDesc: '+1▨(70%)',
    detailedDescription: 'Precise generation. 70% chance the tile is from the target word.',
    type: 'germinate',
    energyCost: 1,
    cooldown: 0,
    uses: -1,
