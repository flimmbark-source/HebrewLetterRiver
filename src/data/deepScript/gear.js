...
export const gearDefinitions = [
  ...
  // --- Interpreter gear ---
  {
    ...
    icon: '🏮',
    shortDesc: 'Reveal +1★',
    detailedDescription: 'Reveals a slot and produces the exact letter for it.',
    type: 'divine',
    energyCost: 2,
    cooldown: 0,
    uses: 3,
  ...
  // --- Rootkeeper gear ---
  {
    ...
    icon: '🔍',
    shortDesc: 'Reveal +1▨',
    detailedDescription: 'Reveals a slot and produces a tile biased toward the target word.',
    type: 'root-sight',
    energyCost: 1,
    cooldown: 0,
    uses: 3,
  ...
  // --- Shared gear ---
  {
    ...
    icon: '🔥',
    shortDesc: '+2 ▨ (40%)',
    detailedDescription: '40% chance each tile is from the target word. Cost increases by 1 each use per turn.',
    type: 'burn',
    energyCost: 1,
    cooldown: 0,
    uses: -1,
