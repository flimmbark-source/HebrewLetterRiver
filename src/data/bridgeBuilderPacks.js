...
export const bridgeBuilderPacks = [
  ...
  },
  {
    ...
    wordIds: ['bbct-he', 'bbct-she', 'bbct-we', 'bbct-they'],
    order: 3,
  ...
  },
  {
    ...
    title: 'Family 2',
    theme: 'family',
    description: 'Parent, neighbor, and stranger',
    wordIds: ['bbct-parent', 'bbct-neighbor', 'bbct-stranger'],
    order: 5,
  ...
  },
  {
    ...
    wordIds: ['bb-lechem', 'bb-mayim', 'bb-cafe', 'bb-tapuach', 'bbct-food'],
    order: 6,
  ...
  },
  {
    ...
    title: 'Adjectives',
    theme: 'adjectives',
    description: 'Good, big, small, beautiful, and more',
    wordIds: ['bb-tov', 'bb-gadol', 'bb-katan', 'bb-yafe', 'bbct-ugly', 'bbct-strange'],
    order: 7,
    unlockAfter: 'food_01',
  },
  {
    ...
    title: 'Adjectives 2',
    theme: 'adjectives',
    description: 'Great, nice, bad, terrible, and wonderful',
    wordIds: ['bbct-great', 'bbct-nice', 'bbct-bad', 'bbct-terrible', 'bbct-wonderful'],
    order: 8,
  ...
  },
  {
    ...
    theme: 'objects',
    description: 'Book, phone, table, door, and thing',
    wordIds: ['bb-sefer', 'bb-telefon', 'bb-shulchan', 'bb-delet', 'bbct-thing'],
    order: 11,
  ...
  },
  {
    ...
    title: 'Time & Days',
    theme: 'time',
    description: 'Today, tomorrow, yesterday, hour, and now',
    wordIds: ['bb-hayom', 'bb-machar', 'bb-etmol', 'bb-shaah', 'bbct-now'],
    order: 3,
  ...
  },
  {
    ...
    title: 'Weather',
    theme: 'weather',
    description: 'Sun, rain, hot, cold, and weather',
    wordIds: ['bb-shemesh', 'bb-geshem', 'bb-cham', 'bb-kar', 'bbct-weather'],
    order: 5,
  ...
  },
  {
    ...
    title: 'Basic Actions',
    theme: 'actions',
    description: 'Eat, drink, go, sleep, come, and work',
    wordIds: ['bb-le-echol', 'bb-lishtot', 'bb-lalechet', 'bb-lishon', 'bbct-come', 'bbct-work'],
    order: 6,
  ...
  },
  {
    ...
    theme: 'actions',
    description: 'Help, wait, leave, arrive, start, finish, and stop',
    wordIds: ['bbct-help', 'bbct-wait', 'bbct-leave', 'bbct-arrive', 'bbct-start', 'bbct-finish', 'bbct-stop'],
    order: 7,
  ...
  },
  {
    ...
    theme: 'shopping',
    description: 'Money, store, how much, bag, buy, and pay',
    wordIds: ['bb-kesef', 'bb-chanut', 'bb-kamah', 'bb-sakit', 'bbct-buy', 'bbct-pay'],
    order: 8,
  ...
  },
  {
    ...
    theme: 'transport',
    description: 'Place, city, and country',
    wordIds: ['bbct-place', 'bbct-city', 'bbct-country'],
    order: 10,
  ...
  },
  {
    ...
    theme: 'people',
    description: 'Someone, everyone, nobody, person, and people',
    wordIds: ['bbct-someone', 'bbct-everyone', 'bbct-nobody', 'bbct-person', 'bbct-people'],
    order: 2,
  ...
  },
  {
    ...
    title: 'Feelings',
    theme: 'feelings',
    description: 'Happy, sad, tired, angry, scared, and surprised',
    wordIds: ['bb-sameach', 'bb-atzuv', 'bb-ayef', 'bb-koes', 'bbct-scared', 'bbct-surprised'],
    order: 3,
  ...
  },
  {
    ...
    title: 'Feelings 2',
    theme: 'feelings',
    description: 'Excited, bored, worried, and confused',
    wordIds: ['bbct-excited', 'bbct-bored', 'bbct-worried', 'bbct-confused'],
    order: 4,
  ...
  },
  {
    ...
    theme: 'helping',
    description: 'Want, need, love, hate, and try',
    wordIds: ['bbct-want', 'bbct-need', 'bbct-love', 'bbct-hate', 'bbct-try'],
    order: 9,
  ...
  },
  {
    ...
    theme: 'actions',
    description: 'Do, get, give, take, find, and lose',
    wordIds: ['bbct-do', 'bbct-get', 'bbct-give', 'bbct-take', 'bbct-find', 'bbct-lose'],
    order: 11,
  ...
  },
  {
    ...
    theme: 'function',
    description: 'So, either, and neither',
    wordIds: ['bbct-so', 'bbct-either', 'bbct-neither'],
    order: 4,
     ...
     ═══════════════════════════════════════════════════════════ */
  {
    ...
    theme: 'cafe_talk',
    description: 'Well, actually, probably, basically, and anyway',
    wordIds: ['bbct-well', 'bbct-actually', 'bbct-probably', 'bbct-basically', 'bbct-anyway'],
  ...
  },
  {
    ...
    theme: 'cafe_talk',
    description: 'Still, just, even, already, and almost',
    wordIds: ['bbct-still', 'bbct-just', 'bbct-even', 'bbct-already', 'bbct-almost'],
