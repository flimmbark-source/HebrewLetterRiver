 ...
 * Grammar patterns presented as example sentences per vocab card
 */
export const module1Grammar1Text = createReadingText({
  id: 'module-1-grammar-1',
  title: {
    en: 'Module 1 Grammar — Greetings',
    he: 'דקדוק מודול 1 — ברכות'
  },
  subtitle: {
  ...
  tokens: [
    ...
    { type: 'word', text: 'את', id: 'at-grammar' },
    { type: 'word', text: 'שמח', id: 'sameach-grammar-3' },
    { type: 'punct', text: '.' },
    { type: 'word', text: 'שלום', id: 'shalom-grammar-4' },
    { type: 'word', text: 'אנחנו', id: 'anachnu-grammar' },
    { type: 'word', text: 'שמח', id: 'sameach-grammar-4' },
    { type: 'punct', text: '!' }
  ],
  glosses: {
    en: {
  ...
  translations: {
    en: {
      ...
      'sameach-grammar-4': { canonical: 'sameach', variants: ['sameach', 'same\'ach'] }
    }
  }
});
...
export const module1Grammar2Text = createReadingText({
  ...
  title: {
    en: 'Module 1 Grammar — Nouns',
    he: 'דקדוק מודול 1 — שמות עצם'
  },
  subtitle: {
    en: 'Practice grammar with vocabulary words',
    he: 'תרגל דקדוק עם מילות אוצר מילים'
...
export const module1Grammar3Text = createReadingText({
  ...
  title: {
    en: 'Module 1 Grammar — Actions',
    he: 'דקדוק מודול 1 — פעולות'
  },
  subtitle: {
    en: 'Practice grammar with vocabulary words',
    he: 'תרגל דקדוק עם מילות אוצר מילים'
