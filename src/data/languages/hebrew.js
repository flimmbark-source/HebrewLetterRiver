export const hebrewConsonants = [
  { id: 'aleph', symbol: 'א', sound: 'Silent (A)', name: 'Aleph' },
  ...
  { id: 'vav', symbol: 'ו', sound: 'Vav', name: 'Vav' },
  ...
  { id: 'chaf', symbol: 'כ', sound: 'Ch (Khaf)', name: 'Chaf' },
  { id: 'final-chaf', symbol: 'ך', sound: 'Ch (Final)', name: 'Final Chaf' },
  { id: 'lamed', symbol: 'ל', sound: 'L', name: 'Lamed' },
  { id: 'mem', symbol: 'מ', sound: 'M', name: 'Mem' },
  { id: 'final-mem', symbol: 'ם', sound: 'M (Final)', name: 'Final Mem' },
  { id: 'nun', symbol: 'נ', sound: 'N', name: 'Nun' },
  { id: 'final-nun', symbol: 'ן', sound: 'N (Final)', name: 'Final Nun' },
  { id: 'samech', symbol: 'ס', sound: 'S', name: 'Samech' },
  { id: 'ayin', symbol: 'ע', sound: 'Silent (Ayin)', name: 'Ayin' },
  { id: 'pei-dagesh', symbol: 'פּ', sound: 'P', name: 'Pei' },
  { id: 'fei', symbol: 'פ', sound: 'F', name: 'Fei' },
  { id: 'final-fei', symbol: 'ף', sound: 'F (Final)', name: 'Final Fei' },
  { id: 'tzadi', symbol: 'צ', sound: 'Tz', name: 'Tzadi' },
  { id: 'final-tzadi', symbol: 'ץ', sound: 'Tz (Final)', name: 'Final Tzadi' },
  { id: 'kuf', symbol: 'ק', sound: 'K (Qof)', name: 'Kuf' },
  { id: 'resh', symbol: 'ר', sound: 'R', name: 'Resh' },
  { id: 'shin', symbol: 'שׁ', sound: 'Sh', name: 'Shin' },
  { id: 'sin', symbol: 'שׂ', sound: 'S (Sin)', name: 'Sin' },
